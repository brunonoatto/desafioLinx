...
namespace Algorithm.Logic.Tests
{
    ...
    public class DroneUnitTest
    {
        ...
        [TestMethod]
        public void Input_BeginX()
        {
            Assert.AreEqual("(999, 999)", Program.Evaluate("XLS"));
        }

        [TestMethod]
        public void Input_ManyCancel()
        {
            Assert.AreEqual("(999, 999)", Program.Evaluate("SL12N13XXXX"));
        }

        [TestMethod]
        public void Input_WithSpace()
        {
            Assert.AreEqual("(999, 999)", Program.Evaluate("S12L9 N2O9"));
        }

        [TestMethod]
        public void Input_N5L10()
        {
            Assert.AreEqual("(10, 5)", Program.Evaluate("N5L10"));
        }
    }
}
